...
lab:
  ...
  description: The production manager, want to get familiar with the setups before using the subcontracting features of Microsoft Dynamics 365 Supply Chain Management.
  duration: 50 minutes
  level: 300
  islab: true
  primarytopics:
